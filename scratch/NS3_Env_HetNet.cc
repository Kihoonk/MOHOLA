...
main (int argc, char *argv[])
{
  ...
  for (uint32_t buildingIndex = 0; buildingIndex < numBlocks; buildingIndex++)
    ...
    // std::vector<Ptr<Building> > buildingVector5;
  ...
  //     * position [3]: coordinates for y max
  //     */
  //     std::pair<Box, std::list<Box> > pairBuildings = GenerateBuildingBounds (70, 730, 70, 730, maxBuildingSize, m_previousBlocks);
  //     m_previousBlocks = std::get<1> (pairBuildings);
  //     Box box = std::get<0> (pairBuildings);
  //     Ptr<UniformRandomVariable> randomBuildingZ = CreateObject<UniformRandomVariable> ();
  //     randomBuildingZ->SetAttribute ("Min",DoubleValue (1.6));
  ...
  //                                   box.yMin,  box.yMax,
  //                                   0.0, buildingHeight));
  //     buildingVector5.push_back (building);
  //   }
  ...
  p2ph.SetDeviceAttribute ("DataRate", DataRateValue (DataRate ("2.2Mb/s")));
  ...
  homeEnbs.Create (8);  
  NodeContainer totlaEnbs;
  totlaEnbs.Add(macroEnbs);
  totlaEnbs.Add(homeEnbs);
  
   MobilityHelper enbMobility;
  enbMobility.SetMobilityModel("ns3::ConstantPositionMobilityModel");
  enbMobility.Install (totlaEnbs);
  ...
  NetDeviceContainer macroEnbDevs = lteHelper->InstallEnbDevice (macroEnbs, son_server);

  Config::SetDefault ("ns3::LteEnbPhy::TxPower", DoubleValue (homeEnbTxPowerDbm));
  NetDeviceContainer homeEnbDevs = lteHelper->InstallEnbDevice (homeEnbs, son_server);

  // NetDeviceContainer ueLteRandomDevs = lteHelper->InstallUeDevice (ueRandomNodes, son_server);

  Ptr<ConstantPositionMobilityModel> enb0 = DynamicCast<ConstantPositionMobilityModel>(macroEnbs.Get(0)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> enb1 = DynamicCast<ConstantPositionMobilityModel>(macroEnbs.Get(1)->GetObject<MobilityModel> ());	 
  Ptr<ConstantPositionMobilityModel> enb2 = DynamicCast<ConstantPositionMobilityModel>(macroEnbs.Get(2)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> enb3 = DynamicCast<ConstantPositionMobilityModel>(macroEnbs.Get(3)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> enb4 = DynamicCast<ConstantPositionMobilityModel>(macroEnbs.Get(4)->GetObject<MobilityModel> ());	

  Ptr<ConstantPositionMobilityModel> homeEnb1 = DynamicCast<ConstantPositionMobilityModel>(homeEnbs.Get(0)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> homeEnb2 = DynamicCast<ConstantPositionMobilityModel>(homeEnbs.Get(1)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> homeEnb3 = DynamicCast<ConstantPositionMobilityModel>(homeEnbs.Get(2)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> homeEnb4 = DynamicCast<ConstantPositionMobilityModel>(homeEnbs.Get(3)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> homeEnb5 = DynamicCast<ConstantPositionMobilityModel>(homeEnbs.Get(4)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> homeEnb6 = DynamicCast<ConstantPositionMobilityModel>(homeEnbs.Get(5)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> homeEnb7 = DynamicCast<ConstantPositionMobilityModel>(homeEnbs.Get(6)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> homeEnb8 = DynamicCast<ConstantPositionMobilityModel>(homeEnbs.Get(7)->GetObject<MobilityModel> ());	
  ...
  // xPos->SetAttribute ("Min", DoubleValue (150.0));
  // xPos->SetAttribute ("Max", DoubleValue (250.0));
  // allocator->SetX (xPos);
  // Ptr<UniformRandomVariable> yPos = CreateObject<UniformRandomVariable> ();
  // yPos->SetAttribute ("Min", DoubleValue (150.0));
  // yPos->SetAttribute ("Max", DoubleValue (250.0));
  // allocator->SetY (yPos);
  // allocator->SetZ (1.5);
  // allocator->AssignStreams (1);
  // ueMobility1.SetPositionAllocator (allocator);
  // ueMobility1.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
  //                            "Bounds", RectangleValue (Rectangle (150, 250, 150, 250)),
  //                            "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=20]"),
  //                            "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  // for (int i=48 ; i < 60; i++)
  // ueMobility1.Install (ueNodes.Get(i));
  ...
  ueMobility2_1.SetPositionAllocator (allocator2);
  ueMobility2_1.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             "Bounds", RectangleValue (Rectangle (50, 350, 85, 110)),
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=20]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  // for (int i= 0 ; i < 3 ; i++)
  ueMobility2_1.Install (ueNodes.Get(0));
  ueMobility2_1.Install (ueNodes.Get(48));
  ...
  ueMobility2_2.Install (ueNodes.Get(49));
  ...
  ueMobility2_6.Install (ueNodes.Get(59));
  ...
  MobilityHelper ueMobility2_7_1;
  ueMobility2_7_1.SetPositionAllocator (allocator2);
  ueMobility2_7_1.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             "Bounds", RectangleValue (Rectangle (50, 350, 70, 120)),
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=15]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility2_7_1.Install (ueNodes.Get(7));
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  ueMobility3_1.SetPositionAllocator (allocator3);
  ueMobility3_1.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             "Bounds", RectangleValue (Rectangle (50, 350, 290, 315)),
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=20]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility3_1.Install (ueNodes.Get(10));
  ...
  ueMobility3_2.Install (ueNodes.Get(58));
  ...
  ueMobility3_3.Install (ueNodes.Get(50));
  ...
  ueMobility3_4.Install (ueNodes.Get(51));
  ...
  MobilityHelper ueMobility3_7_1;
  ueMobility3_7_1.SetPositionAllocator (allocator3);
  ueMobility3_7_1.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             "Bounds", RectangleValue (Rectangle (50, 350, 280, 330)),
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=15]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility3_7_1.Install (ueNodes.Get(17));
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  ueMobility4_4.Install (ueNodes.Get(57));
  ...
  ueMobility4_5.Install (ueNodes.Get(52));
  ...
  ueMobility4_6.Install (ueNodes.Get(53));
  ...
  MobilityHelper ueMobility4_8;
  ueMobility4_8.SetPositionAllocator (allocator4);
  ueMobility4_8.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             "Bounds", RectangleValue (Rectangle (280, 330, 50, 350)),
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=55]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility4_8.Install (ueNodes.Get(28));

  MobilityHelper ueMobility4_9;
  ueMobility4_9.SetPositionAllocator (allocator4);
  ueMobility4_9.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             "Bounds", RectangleValue (Rectangle (280, 330, 50, 350)),
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=60]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility4_9.Install (ueNodes.Get(29));
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  ueMobility5_7_1.Install (ueNodes.Get(56));


  MobilityHelper ueMobility5_8;
  ueMobility5_8.SetPositionAllocator (allocator5);
  ueMobility5_8.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             "Bounds", RectangleValue (Rectangle (70, 120, 50, 350)),
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=55]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility5_8.Install (ueNodes.Get(38));
  ueMobility5_8.Install (ueNodes.Get(54));

  MobilityHelper ueMobility5_9;
  ueMobility5_9.SetPositionAllocator (allocator5);
  ueMobility5_9.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             "Bounds", RectangleValue (Rectangle (70, 120, 50, 350)),
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=60]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility5_9.Install (ueNodes.Get(39));
  ueMobility5_8.Install (ueNodes.Get(55));
 ...
 //고정 UE
  ...
  ueMobility.Install (ueNodes.Get(40));
  ueMobility.Install (ueNodes.Get(41));
  ueMobility.Install (ueNodes.Get(42));
  ueMobility.Install (ueNodes.Get(43));
  ueMobility.Install (ueNodes.Get(44));
  ueMobility.Install (ueNodes.Get(45));
  ueMobility.Install (ueNodes.Get(46));
  ueMobility.Install (ueNodes.Get(47));
  Ptr<ConstantPositionMobilityModel> m0 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(40)->GetObject<MobilityModel> ());	  
  Ptr<ConstantPositionMobilityModel> m1 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(41)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> m2 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(42)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> m3 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(43)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> m4 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(44)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> m5 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(45)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> m6 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(46)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> m7 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(47)->GetObject<MobilityModel> ());	

 
m0->SetPosition(Vector(160,80,1.6));
m1->SetPosition(Vector(240,80,1.6));

m2->SetPosition(Vector(160,320,1.6)); 
m3->SetPosition(Vector(240,80,1.6)); 

m4->SetPosition(Vector(80,160,1.6));
m5->SetPosition(Vector(80,240,1.6)); 

m6->SetPosition(Vector(320,160,1.6)); 
m7->SetPosition(Vector(320,240,1.6)); 

homeEnb1->SetPosition(Vector(160,80,1.5));
homeEnb2->SetPosition(Vector(240,80,1.5));
homeEnb3->SetPosition(Vector(160,320,1.5));
homeEnb4->SetPosition(Vector(240,320,1.5));
homeEnb5->SetPosition(Vector(80,160,1.5));
homeEnb6->SetPosition(Vector(80,240,1.5));
homeEnb7->SetPosition(Vector(320,160,1.5));
homeEnb8->SetPosition(Vector(320,240,1.5));
...
BuildingsHelper::Install (ueNodes);
  ...
  // ueIpIfaces = epcHelper->AssignUeIpv4Address (NetDeviceContainer (ueLteRandomDevs));
  ...
  //   }
  // // for (uint16_t i = 0; i < numberOfRandomUes; i++)
  // //   {
  // //     lteHelper->AttachToClosestEnb (ueLteRandomDevs.Get(i), enbLteDevs);
  // //   }
  ...
  // No use
  Time udpInterval = Seconds (0.01); //0.1
          ...
          if (!disableDl)
            {
              ...
              dlClientHelper.SetAttribute ("MaxPackets", UintegerValue (5000));
          ...
          if (!disableUl)
            {
              ...
              ulClientHelper.SetAttribute ("MaxPackets", UintegerValue (5000));
...
// for (uint32_t u = 0; u < numberOfRandomUes; ++u) //0525
//     {
//       Ptr<Node> ueR = ueRandomNodes.Get (u);
//       // Set the default gateway for the UE
//       Ptr<Ipv4StaticRouting> ueStaticRouting = ipv4RoutingHelper.GetStaticRouting (ueR->GetObject<Ipv4> ());
//       ueStaticRouting->SetDefaultRoute (epcHelper->GetUeDefaultGatewayAddress (), 1);
...
//               PacketSinkHelper dlPacketSinkHelper ("ns3::UdpSocketFactory",
//                                                    InetSocketAddress (Ipv4Address::GetAny (), dlPort));
//               serverApps.Add (dlPacketSinkHelper.Install (ueR));
...
//               clientApps.Add (ulClientHelper.Install (ueR));
//               PacketSinkHelper ulPacketSinkHelper ("ns3::UdpSocketFactory",
//                                                    InetSocketAddress (Ipv4Address::GetAny (), ulPort));
//               serverApps.Add (ulPacketSinkHelper.Install (remoteHost));
...
//           EpsBearer bearer (EpsBearer::NGBR_VIDEO_TCP_DEFAULT);
//           lteHelper->ActivateDedicatedEpsBearer (ueLteRandomDevs.Get (u), bearer, tft);
//           Time startTime = Seconds (startTimeSeconds->GetValue ());
//           serverApps.Start (startTime);
//           clientApps.Start (startTime);
...
//     }
  ...
  // Add X2 interface
  lteHelper->AddX2Interface (totlaEnbs);
  ...
  rlcStats->SetAttribute ("DlRlcOutputFilename", StringValue ("Throughput_TARO.txt"));
  ...
  for (uint32_t it = 0; it != macroEnbs.GetN(); ++it) {
   ...
   for (uint32_t it = 0; it != homeEnbs.GetN(); ++it) {
        Ptr < NetDevice > netDevice = homeEnbDevs.Get(it);
        Ptr < LteEnbNetDevice > enbNetDevice = netDevice -> GetObject < LteEnbNetDevice > ();
        Ptr < LteEnbPhy > enbPhy = enbNetDevice -> GetPhy();
        enbPhy -> TraceConnectWithoutContext("DlPhyTransmission", MakeBoundCallback( & MyGymEnv::GetPhyStats, son_server));
  }
