...
namespace ns3 {
    ...
    class MyGymEnv: public OpenGymEnv {
        public: 
            ...
            std::vector<double> Currentaveragerbutil; //529
            std::vector<double> pre_averagerbutil; //529
            ...
            // 결과를 위한 부분
            // int RlfCount_Result = 0;
            // int PingpongCount_Result = 0;
