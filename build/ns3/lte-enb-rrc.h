...
public: 
  ...
  bool HoSuccess = true;
  uint64_t handovernum ; //0605
  bool GetHoSuccess(void);
  void SetHoSuccess (bool newHoSuccess);
  uint64_t Gethandovernum(void);
  void Sethandovernum (void);
  /**
