...
public:
  ...
  // TTT, HOM
  ///////////////////////////////
  // uint16_t Ttt = 480; // New
  // double Hom = 14.0; //New
  uint16_t Ttt = 320; // New //320
  double Hom = 3; //New  //3

  // TTT = [0, 40, 64, 80, 100, 128, 160, 256, 320, 480, 512, 640, 1024, 1280, 2560, 5120] ms (16 values)
  void ChangeTtt (uint16_t TTT); //New
  // HOM = [0.0, 1.0, 2.0, ... , 30.0] dB (31 values)
  void ChangeHom (double HOM); //New

  uint16_t TttIndex = 9;
  uint16_t HomIndex = 14;
