...
CFLAGS_PYEMBED = ['-g', '-fdebug-prefix-map=/build/python3.8-YBWzqg/python3.8-3.8.10=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
CFLAGS_PYEXT = ['-g', '-fdebug-prefix-map=/build/python3.8-YBWzqg/python3.8-3.8.10=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
...
CXXFLAGS_PYEMBED = ['-g', '-fdebug-prefix-map=/build/python3.8-YBWzqg/python3.8-3.8.10=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
CXXFLAGS_PYEXT = ['-g', '-fdebug-prefix-map=/build/python3.8-YBWzqg/python3.8-3.8.10=.', '-fstack-protector', '-g', '-fwrapv', '-O3', '-fvisibility=hidden', '-Wno-array-bounds']
...
ENABLE_ZMQ = True
EXAMPLE_DIRECTORIES = ['tcp', 'udp', 'matrix-topology', 'traffic-control', 'realtime', 'ipv6', 'tutorial', 'error-model', 'routing', 'wireless', 'channel-models', 'udp-client-server', 'stats', 'naming', 'energy', 'socket']
...
NS3_EXECUTABLE_PATH = ['/home/mncgpu5/kihoon/Paper/build/src/fd-net-device', '/home/mncgpu5/kihoon/Paper/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/9', '/home/mncgpu5/kihoon/Paper/build/lib', '/home/mncgpu5/kihoon/Paper/build']
...
cfg_files = ['/home/mncgpu5/kihoon/Paper/build/ns3/config-store-config.h', '/home/mncgpu5/kihoon/Paper/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
